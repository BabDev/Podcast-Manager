...
(function() {
var PodcastMediaManager = this.PodcastMediaManager = {
	...
	initialize: function()
	{
		...
		this.tree = new MooTreeControl({ div: 'media-tree_tree', mode: 'folders', grid: true, theme: '../media/system/images/mootree.gif', onClick:
			...
			},{ text: 'Media', open: true, data: { url: 'index.php?option=com_podcastmedia&view=mediaList&tmpl=component', target: 'folderframe'}});
...
window.addEvent('domready', function(){
	...
	PodcastMediaManager.trace = 'start';
	document.updateUploader = function() { PodcastMediaManager.onloadframe(); };
