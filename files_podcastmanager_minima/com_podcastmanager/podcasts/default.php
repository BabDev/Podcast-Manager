...
<div class="filter-search fltlft"><label class="filter-search-lbl"
...
<div class="filter-select fltrt"><select name="filter_published"
...
<div id="pagination-top"><?php echo $this->pagination->getListFooter(); ?>
</div>
	<?php endif; ?>
<div class="clr"></div>
...
<table class="adminlist" id="adminlist">
	<thead>
		<tr>
			...
			<th width="2%"><?php echo JHtml::_('grid.sort', 'JGRID_HEADING_ID', 'a.id', $listDirn, $listOrder); ?>
			</th>
			<th><?php echo JHtml::_('grid.sort', 'JGLOBAL_TITLE', 'a.title', $listDirn, $listOrder); ?>
			</th>
			<th width="5%"><?php echo JHtml::_('grid.sort', 'JSTATUS', 'a.published', $listDirn, $listOrder); ?>
			</th>
			<th width="5%" class="nowrap"><?php echo JHtml::_('grid.sort', 'JGRID_HEADING_LANGUAGE', 'a.language', $listDirn, $listOrder); ?>
			</th>
		</tr>
	</thead>
	...
	?>
		<tr class="row<?php echo $i % 2; ?>">
			...
			<td class="center table-id"><?php echo (int) $item->id; ?></td>
			<td><?php if ($item->checked_out) : ?> <?php echo JHtml::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'podcasts.', $canCheckin); ?>
			<?php endif; ?> <?php if ($canEdit) : ?> <a class="title"
				href="<?php echo JRoute::_('index.php?option=com_podcastmanager&task=podcast.edit&id='.$item->id);?>">
			...
			<td class="center"><?php if ($item->language=='*'):?> <?php echo JText::_('JALL','language'); ?>
		...
		<?php if ($this->pagination->total > 0) : ?>
<div id="pagination-bottom"><?php echo $this->pagination->getListFooter(); ?>
</div>
		<?php endif; ?>
